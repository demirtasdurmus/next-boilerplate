...
export default function Products() {
  const onClose = async () => {
    ...
    // run some server side code here
  ...
  return (
    <>
      <Dialog title="Example Dialog" onClose={onClose} onOk={onOk}>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel nulla
          dolorum odit perspiciatis nisi saepe quasi in porro iste illum
          aspernatur beatae sapiente provident cupiditate, recusandae dolorem
          repudiandae exercitationem voluptate.
        </p>
      </Dialog>
      ...
      <section className="flex flex-col gap-4 p-4 text-2xl">
        <p>
        ...
        <p>
          ...
          suscipit? Quibusdam consequuntur autem voluptates magni, tenetur eos
          ea aliquid, assumenda, voluptas atque voluptatum iste odit magnam
